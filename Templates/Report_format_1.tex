...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Eric Clepper (Clemson University)},
...
\textbf{\authorfont Eric Clepper} \hskip 15pt \emph{\small Clemson
University}   
...
\AttributeTok{Want a table? This will create one.}
...
\NormalTok{uniondensity }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{z\_left =} \FunctionTok{r2sd}\NormalTok{(left), }\AttributeTok{z\_size =} \FunctionTok{r2sd}\NormalTok{(size), }\AttributeTok{z\_concen =} \FunctionTok{r2sd}\NormalTok{(concen)) }\OtherTok{{-}\textgreater{}}
\NormalTok{    uniondensity}
\NormalTok{M1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(union }\SpecialCharTok{\textasciitilde{}}\NormalTok{ z\_left }\SpecialCharTok{+}\NormalTok{ z\_size }\SpecialCharTok{+}\NormalTok{ z\_concen, }\AttributeTok{data =}\NormalTok{ uniondensity)}
\CommentTok{\# library(arm)}
\NormalTok{arm}\SpecialCharTok{::}\FunctionTok{coefplot}\NormalTok{(M1)}
\end{Highlighting}
\end{Shaded}
